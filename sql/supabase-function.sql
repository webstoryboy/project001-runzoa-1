...
--
-- [RPC]
-- 3. 프로필 이름 중복 확인              is_full_name_available
-- 4. 계정 탈퇴 여부 체크               is_my_account_deleted
-- 5. 로그인 시 방문 횟수 증가           increment_visit_count
